...
function Tweet(props) {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      await axios.put(`http://ec2-54-87-169-244.compute-1.amazonaws.com:8080/api/v1.0/tweets/${globalState.user.username}/update/${tweet.id}`, theTweet)
  ...
  async function handleDelete(e) {
    ...
    try {
      ...
      await axios.delete(`http://ec2-54-87-169-244.compute-1.amazonaws.com:8080/api/v1.0/tweets/${globalState.user.username}/delete/${tweet.id}`)
  ...
  async function handleLike() {
    try {
      ...
      // await axios.put(`http://localhost:8080/api/v1.0/tweets/${globalState.user.username}/like/${tweet.id}`)
       await axios.put(`http://ec2-54-87-169-244.compute-1.amazonaws.com:8080/api/v1.0/tweets/${globalState.user.username}/like/${tweet.id}`)
  ...
  async function handleUnlike() {
    try {
      ...
      await axios.put(`http://ec2-54-87-169-244.compute-1.amazonaws.com:8080/api/v1.0/tweets/${globalState.user.username}/unlike/${tweet.id}`)
