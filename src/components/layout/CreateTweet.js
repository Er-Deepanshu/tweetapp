...
function CreateTweet() {
  ...
  async function handleSubmit(e) {
    ...
    await axios.post(`http://ec2-54-87-169-244.compute-1.amazonaws.com:8080/api/v1.0/tweets/${globalState.user.username}/add`, theTweet)
  ...
  return (<div className="tweetLanding">
    <div className="container p-3" >
      <div className="theme-white m-auto p-2 pe-3 rounded-5 ">
        <div className="row">
          <div className="col-2 ps-3">
            <img className="tweet-profile" src={defaultUser} alt="Profile " />
          </div>
          <div className="col-8">
