...
function Register() {
  ...
  async function handleSubmit(e) {
    ...
    if (password === confirmPassword) {
      ...
      await axios.post("http://ec2-54-87-169-244.compute-1.amazonaws.com:8080/api/v1.0/tweets/register", theUser)
  ...
  return (
    <>
      <div className="container pt-5">
        <form className="theme-black inner ps-4 pe-3 pt-5 pb-2 w-50 shadow-lg" onSubmit={handleSubmit}>
