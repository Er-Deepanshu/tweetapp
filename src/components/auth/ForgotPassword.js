...
function ForgotPassword() {
  ...
  async function handleSubmit(e) {
    ...
    if (password === confirmPassword) {
      try {
        ...
        const response = await axios.post(`http://ec2-54-87-169-244.compute-1.amazonaws.com:8080/api/v1.0/tweets/${username}/forgot`, password)
  ...
  return (
    <div className="container pt-5">
      ...
      <form className="theme-black inner p-5 w-50 shadow-lg" onSubmit={handleSubmit}>
        <div className="title">Please Reset Password!</div>
        ...
        <div className="input-container pt-3">
          ...
          <input className="form-control text-left" onChange={e => setConfirmPassword(e.target.value)} type="password" name="password" placeholder="Enter Confirm new password" required />
        </div>
