  ...
  useEffect(() => {
    async function fetchAllUsers() {
      try {
        ...
        const response = await axios.get("http://ec2-54-87-169-244.compute-1.amazonaws.com:8080/api/v1.0/tweets/users/all")
          ...
          users.map(user => {
            return (
              <div key={user.id} className="col-4">
                <div className="theme-black rounded-5 p-3 shadow py-3">
